...
import org.blackum.blackaddons.command.CommandUtils;
        ...
        public static void register() {
                ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> {
                        ...
                        testNode.then(ClientCommandManager.literal("resetalign")
                                        .executes(ctx -> {
                                                org.blackum.blackaddons.common.util.AlignUtils.resetSessionStats();
                        ...
                        testNode.then(ClientCommandManager.literal("dungeonforce")
                                        .executes(ctx -> {
                                                org.blackum.blackaddons.common.util.LocationUtils.debugDungeonMode = !org.blackum.blackaddons.common.util.LocationUtils.debugDungeonMode;
                                                ctx.getSource().sendFeedback(Component.literal("Debug dungeon mode: " + (org.blackum.blackaddons.common.util.LocationUtils.debugDungeonMode ? "§aON" : "§cOFF")));
                                                return 1;
                                        }));
                        ...
                        for (String alias : new String[] { Constants.BASE_COMMAND, "black", "blackaddons" }) {
                                ...
                                cmd.then(ClientCommandManager.literal("tablist").executes(ctx -> {
                                        ...
                                        for (String line : org.blackum.blackaddons.common.util.TabListUtils.getTabListLines()) {
