...
public class CommandUtils {
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        ...
        ConfigManager.knownAliases.forEach((name, command) -> {
    ...
    static ArgumentBuilder<FabricClientCommandSource, ?> add = ClientCommandManager.literal("add")
            ...
            .executes(ctx -> {
                ...
                ConfigManager.knownAliases.put(name, desc);
                ConfigManager.save();
    ...
    static ArgumentBuilder<FabricClientCommandSource, ?> del = ClientCommandManager.literal("del")
            ...
            .suggests((ctx, builder) -> {
                ...
                ConfigManager.knownAliases.forEach((alias, command) -> { existing.add(alias); });
                ConfigManager.save();
            ...
            .executes(ctx -> {
                ...
                ConfigManager.knownAliases.remove(name);
                ConfigManager.save();
    ...
    static ArgumentBuilder<FabricClientCommandSource, ?> list = ClientCommandManager.literal("list")
            .executes(ctx -> {
                ...
                ConfigManager.knownAliases.forEach((alias, command) -> {
